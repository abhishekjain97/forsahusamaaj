...
<section class="content">
    <div class="container-fluid">
        <a href="{{ route('sahusamaajsanghathan.index') }}" class="btn btn-success">All Sanghathan</a>
        <br><br>
        <div class="row">
            <!-- left column -->
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('sahusamaajsanghathan.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
