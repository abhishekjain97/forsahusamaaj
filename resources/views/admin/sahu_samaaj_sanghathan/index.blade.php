...
<section class="content">
    <div class="container-fluid">
        <a href="{{ route('sahusamaajsanghathan.create') }}" class="btn btn-success">Add Sanghathan </a>
        <br><br>
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset('uploads/sahu_samaaj_sanghathan/' . $mahotsav->image) }}" alt=""
                                    ...
                                    <td>
                                        <form action="{{ route('sahusamaajsanghathan.destroy', $mahotsav->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <form role="form"
                                                            action=" {{ route('sahusamaajsanghathan.update', $mahotsav->id) }} "
