...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <a href="{{url('admin/subcategory/'.$category->id)}}" class="btn btn-success">All Sub Category of {{$category->name}}</a>
            <br><br>
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action=" {{ url('admin/addsubcat') }} " method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly value="{{$category->name}}" class="form-control"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
