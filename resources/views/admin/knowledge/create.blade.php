                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="sub_menu" placeholder="Sub Menu"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="sub_sub_menu" id="sub-sub-menu"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                            ...
                                            <div class="displayImagesShow" id="displayImagesShow" style="margin-top: 5px;"
                                                ...
                                                <div class="" style="margin-top: 5px; display: block;">
                                                    <div style="border: 2px solid #dedada;padding: 5px;width: 40%;">
                                                        <img src="<?= base_url('assets/admin_link/Banners/' . @$details['images']) ?>" alt="your image" width="100%" height="40%">
                                       ...
                                       <?php } else { ?>
                                          <div class="displayImagesShow" id="displayImagesShow" style="margin-top: 5px;" accept="image/*" ></div>
                                       <?php } ?>
                                    </div>
                                    </div>
                                ...
                                <div class="row">
                                     <div class="col-sm-4"  >
                                           <div class="form-group">
                                            <label>Tags<!-- <span class="err_color">*</span> --></label>
                                             {{-- <input type="text" class="form-control " placeholder="Tags" name="tags" value="{{ old('tags') }}" > --}}
                                             <select class="js-example-tags js-example-tokenizer form-control"  multiple="multiple" name="tags[]" aria-hidden="true">
                                     ...
                                     <div class="col-sm-4"  >
                                           <div class="form-group">
                                            <label>Meta Title<!-- <span class="err_color">*</span> --></label> 
                                     ...
                                     <div class="col-sm-4"  >
                                           <div class="form-group">
                                            <label>Meta Keyword<!-- <span class="err_color">*</span> --></label> 
                                             {{-- <input type="text" class="form-control" placeholder="Meta Keyword" name="meta_keyword" value="{{ old('meta_keyword') }}" > --}}

                                             <select class="js-example-tags js-example-tokenizer form-control"  multiple="multiple" name="meta_keyword[]" aria-hidden="true">
                                     ...
                                     <div class="col-sm-12"  >
                                           <div class="form-group">
                                            <label>Meta Description<!-- <span class="err_color">*</span> --></label> 
                                             <textarea class="form-control" name="meta_description"  >{{ old('meta_description') }}</textarea>
                                          </div>
                                    </div>
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                         <label>Author<!-- <span class="err_color">*</span> --></label>
