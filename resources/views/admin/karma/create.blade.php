...
<section class="content">
    <div class="container-fluid">
        <a href="{{ route('karma.index') }}" class="btn btn-success">All karma</a>
        <br><br>
        <div class="row">
            <!-- left column -->
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('karma.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
