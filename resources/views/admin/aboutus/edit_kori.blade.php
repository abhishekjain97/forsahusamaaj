...
@section('sitetitle', 'Edit Kori About Us')
@section('title', 'Edit Kori About Us')
...
<section class="content">
    <div class="container-fluid">
        <a href="{{ route('koriindex') }}" class="btn btn-success">All KSSKS About Us</a>
        <br><br>
        <div class="row">
            <!-- left column -->
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action=" {{ route('koriupdate',$aboutUs->id) }} " method="POST"
