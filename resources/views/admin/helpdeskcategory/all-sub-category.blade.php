...
<section class="content">
    <div class="container-fluid">
        <a href="{{ url('admin/helpdeskaddsubcat/' . $categoryName->id) }}" class="btn btn-success">Add Sub Category of
            {{ $categoryName->name }} </a>
        <br><br>
        <div class="row">
            <div class="col-12">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('helpdeskcategory.destroy', $subCategory->id) }}"
                                            method="POST">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <form role="form"
                                                            action=" {{ route('helpdeskcategory.update', $subCategory->id) }} "
                                                            method="POST">
                                                            @method('PUT')
                                                            @csrf
                                                            <div class="row">
