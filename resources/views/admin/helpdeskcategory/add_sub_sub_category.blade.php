...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <a href="{{url('admin/helpdesksub-sub-category/'.$subCategory->id)}}" class="btn btn-success">All Sub-Sub Category of {{$subCategory->name}}</a>
            <br><br>
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action=" {{ url('admin/helpdeskadd-sub-sub-cat') }} " method="POST"
