...
@section('sitetitle', 'All mahotsav Images')
@section('title', 'All mahotsav Images')

@section('content')

<section class="content">
    <div class="container-fluid">
        <a href="{{ route('mahotsav.create') }}" class="btn btn-success">Add Mahotsav </a>
        <br><br>
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset('uploads/mahotsav/' . $mahotsav->image) }}" alt=""
                                    ...
                                    <td>
                                        <form action="{{ route('mahotsav.destroy', $mahotsav->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <form role="form"
                                                            action=" {{ route('mahotsav.update', $mahotsav->id) }} "
															...
															<div class="form-group">
                                                                ...
                                                                <input type="text" name="address" class="form-control"
                                                                    value="{{ $mahotsav->address }}" required>
                                                            </div>
