...
@section('sitetitle', 'All Publication Images')
@section('title', 'All Publication Images')
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset('uploads/publication/' . $mahotsav->image) }}" alt=""
                                            height="100px" width="100px"></td>
                                    <td>{{$mahotsav->title}}</td>
									<td>{{$mahotsav->price}}</td>
                                    <td> {{ date("d-M-Y", strtotime($mahotsav->date)) }} </td>
									<td>{{$mahotsav->status}}</td>
                                    {{-- <td>{{$mahotsav->address}}</td> --}}
                                    <td>
                                        <form action="{{ route('publication.destroy', $mahotsav->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <form role="form"
                                                            action=" {{ route('publication.update', $mahotsav->id) }} "
