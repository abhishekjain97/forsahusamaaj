...
@section('sitetitle', 'Edit Help Desk')
@section('title', 'Edit Help Desk')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Edit Help Desk</h3>
                    </div>

                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action=" {{ route('helpdesk.update',$helpdesk->id) }} " method="POST"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Description" id="description"
                                            name="description"> {{ $helpdesk->description }} </textarea>
                                    </div>
                                </div>
                            </div>
