...
@section('title', 'Add Hamare Gaurav')
...
<section class="content">
    <div class="container-fluid">
        <a href="{{ route('hamaregaurav.index') }}" class="btn btn-success">All Hamare Gaurav</a>
        <br><br>
        <div class="row">
            <!-- left column -->
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('hamaregaurav.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
