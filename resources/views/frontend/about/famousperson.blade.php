...
<div class="main-container">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="card mb-12 mb-4">
                                <form method="get" action="{{ route('famousperson') }}">
                                <!-- @csrf -->
                                <div class="card-body row">
                                        ...
                                        <div class="input-group">
                                            <select class="form-control" data-live-search="true" name="state_id" id="state_id" tabindex="-98">
                                                ...
                                                @foreach($states as $state)
                                                    <option value="{{$state->id}}" <?php if($state->id == $request->state_id){ echo 'selected'; } ?>>{{ $state->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="name" value="{{ $request->name }}" placeholder="Enter search name..." aria-label="Enter search name..." aria-describedby="button-search" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="input-group">
    ...
    <div class="events-schedules-area">
        <div class="container">
            ...
            <div class="row">
                @for ($i = 0; $i < count($sanghathans); $i++)
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="single-events-schedules">
                        <div class="events-image">
                            <a href="{{ route('famouspersonDetail', $sanghathans[$i]->name) }}">
                                <img style="width:500px; height: 250px"
                                    src="{{ asset('uploads/famous_person/' . $sanghathans[$i]->image) }}" alt="image">
                            </a>
                        </div>

                        <div class="events-content">
                            <div><span><i class="fa fa-arrow-circle-right"></i>
                                {!! $sanghathans[$i]->tagline !!}</span></div>
                            <h3 class="h3">
                                <a
                                    href="{{ route('famouspersonDetail', $sanghathans[$i]->name) }}">{{ Str::limit($sanghathans[$i]->name,20) }}</a>
                            </h3>
                        ...
                        <div class="event-footer">
                            <div class="view_more book-btn text-center">
                                <a href="{{ route('famouspersonDetail', $sanghathans[$i]->name) }}" class="book-btn-one"><i class="fa fa-angle-right"></i> Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
