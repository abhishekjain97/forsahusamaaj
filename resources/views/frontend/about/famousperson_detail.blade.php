                        ...
                        <article>
                            ...
                            <header class="mb-4">
                                ...
                                <div class="text-muted fst-italic mb-2">
                                    Date of birth - {{ date('F d, Y', strtotime($data->dob)) }}, 
                                    Death date - {{ date('F d, Y', strtotime($data->death_date)) }}
                                </div>
                                <!-- Post categories-->
                            ...
                            <figure class="mb-4"><img class="img-fluid rounded" src="{{ asset('uploads/famous_person/' . $data->image) }}" alt="..." /></figure>
                            <!-- Post content-->
							<section class="mb-5">
                                {!! $data->tagline !!}
                            </section>
