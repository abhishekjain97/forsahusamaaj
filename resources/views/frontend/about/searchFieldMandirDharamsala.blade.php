<div class="card-body">
    ...
    <div class="col-md-3">
        <select class="form-control" data-live-search="true" name="sanghanthantype" tabindex="-98">
            <option value="">Select Type</option>
            <option value="Dharmshala" <?php if('Dharmshala' == $request->sanghanthantype){ echo 'selected'; } ?>>Dharmshala</option>
            <option value="Mandir" <?php if('Mandir' == $request->sanghanthantype){ echo 'selected'; } ?>>Mandir</option>
            <option value="Both" <?php if('Both' == $request->sanghanthantype){ echo 'selected'; } ?>>Both</option>
        </select>
    </div>
    <div class="col-md-3">
