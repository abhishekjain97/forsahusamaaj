            ...
            <div class="col-md-12">
                <div style="float:right">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">About Sahi Samaj</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 mt20">
                <div class="row">
                    <div class="error-block mb80">
                        <h1>404</h1>
                        <h2><i class="fa fa-warning"></i>oooopppss! page was not found, Sorry! it looks like that page
                            has gone missing.</h2>
                    ...
                    <div class="col-md-3 side-nav" id="leftCol">
                        <div class="hide-side">
                            <ul class="listnone nav" id="sidebar">
                                @foreach ($aboutUsMenu as $menu)
                                <li class="@if ($aboutUs->id == $menu->id)
                                    {{'active'}}
                                @endif"><a href="{{route('aboutkssks', $menu->id)}}">{{$menu->menu_name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
