        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-header">
                    <h1>रन फॉर वीरांगना रजिस्ट्रेशन</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <ol class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">रन फॉर वीरांगना रजिस्ट्रेशन</h1>
                    </li>
                </ol>
            </div>
        </div>
...
<div class="main-container">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="well-box">
                    <form action="{{route('runforviranganacreate')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row well-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" style="margin-bottom:13px">
                                    <label class="control-label">Gender<span class="required">*</span></label>
                                    <div style="margin-top:10px">
                                        <input type="checkbox" name="agree" required> <b>I hereby agree that tha
                                            organizer shall not be liable for any accident, Injury Death lose or damaged
                                            a consequence of my participation in the 3.00 K.M. Run for veerangana I also
                                            hereby declare that I am medically fit to tackle the course.</b>
